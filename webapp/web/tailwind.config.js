  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        display: ["Satoshi", "Geist", "Outfit", "Sora", "ui-sans-serif", "system-ui", "sans-serif"],
      ...
      colors: {
        ...
        "surface-up": "hsl(var(--surface-up) / <alpha-value>)",
        primary: {
        ...
        lima: {
          DEFAULT: "hsl(var(--lima) / <alpha-value>)",
        },
        violeta: {
          DEFAULT: "hsl(var(--violeta) / <alpha-value>)",
        },
        rose: {
