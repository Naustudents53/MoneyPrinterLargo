...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-xl border border-border/10 bg-background/60 p-1 text-muted-foreground shadow-[inset_0_1px_0_hsl(var(--foreground)/.04)] backdrop-blur",
      className
    )}
    {...props}
  />
